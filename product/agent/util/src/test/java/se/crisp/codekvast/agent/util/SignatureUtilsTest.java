...
public class SignatureUtilsTest {
    ...
    public void testGetSignatureM1() throws IOException, NoSuchMethodException {
        String s = signatureToString(makeSignature(TestClass.class, TestClass.class.getMethod("m1", String.class, Collection.class)));
    ...
    public void testGetSignatureM2() throws IOException, NoSuchMethodException {
        String s = signatureToString(makeSignature(TestClass.class, TestClass.class.getMethod("m2")));
    ...
    public void testGetSignatureM3() throws IOException, NoSuchMethodException {
        String s = signatureToString(makeSignature(TestClass.class, TestClass.class.getMethod("m3", int.class, String[].class)));
