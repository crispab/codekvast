package io.codekvast.agent.api.util;
...
public class PublishingUtilsTest {
    ...
    public void should_strip_existing_modifiers() throws Exception {
        String stripped = PublishingUtils.stripModifiers("public static strictfp void hudson.ClassicPluginStrategy.2(java.io.OutputStream, long)");
