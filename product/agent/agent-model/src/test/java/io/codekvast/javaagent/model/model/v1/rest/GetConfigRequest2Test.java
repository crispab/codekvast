...
public class GetConfigRequest2Test {
    ...
    public void should_convert_from_format1() {
        GetConfigRequest2 req2 = GetConfigRequest2.fromFormat1(GetConfigRequest1.sample(), "some-environment");
        assertThat(req2, is(GetConfigRequest2.sample().toBuilder().environment("some-environment").build()));
    }
