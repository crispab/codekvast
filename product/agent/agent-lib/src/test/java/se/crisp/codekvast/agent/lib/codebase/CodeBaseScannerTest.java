...
import se.crisp.codekvast.agent.lib.codebase.scannertest.ScannerTest1;
import se.crisp.codekvast.agent.lib.codebase.scannertest.ScannerTest2;
import se.crisp.codekvast.agent.lib.codebase.scannertest.ScannerTest3;
import se.crisp.codekvast.agent.lib.codebase.scannertest.ScannerTest4;
import se.crisp.codekvast.agent.lib.codebase.scannertest.excluded.ExcludedScannerTest5;
...
public class CodeBaseScannerTest {
    ...
    public void testFindBaseMethodForScannerTest2() throws URISyntaxException {
        scanner.findTrackedMethods(codeBase, ImmutableSet.of("se."), ImmutableSet.of("acme."), ScannerTest2.class);
    ...
    public void testFindBaseMethodForScannerTest3() throws URISyntaxException {
        scanner.findTrackedMethods(codeBase, ImmutableSet.of("se."), ImmutableSet.of("acme."), ScannerTest3.class);
    ...
    public void testFindBaseMethodForScannerTest4() throws URISyntaxException {
        scanner.findTrackedMethods(codeBase, ImmutableSet.of("se."), ImmutableSet.of("acme."), ScannerTest4.class);
