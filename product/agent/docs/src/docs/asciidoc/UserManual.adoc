...
....
== Installation
=== Codekvast Collector and Codekvast Agent
...
. `cp codekvast-agent.properties.sample.${codekvast-version} codekvast-agent.properties`

. Edit `codekvast-agent.properties` to suit your needs.

. `cd /etc/init.d`

. `cp /opt/codekvast-agent/etc/init.d/codekvast-agent .`

. `chkconfig --add codekvast-agent`

. `./codekvast-agent start`
...
. `cp codekvast-server.properties.sample.${codekvast-version} codekvast-server.properties`

. Edit `codekvast-server.properties` to suit your needs.

. `cd /etc/init.d`

. `cp /opt/codekvast-server/etc/init.d/codekvast-server .`

. `chkconfig --add codekvast-server`

. `./codekvast-server start`
