...
public class SignatureUtilsTest {
    ...
    public void testGetSignaturePublicStaticMethod() throws IOException, NoSuchMethodException {
        String s = SignatureUtils
            .signatureToString(SignatureUtils.makeSignature(TestClass.class, findTestMethod("publicStaticMethod1")), true);
        assertThat(s,
                   is("public io.codekvast.agent.lib.util.SignatureUtilsTest.TestClass.publicStaticMethod1(java.lang.String, java.util" +
                          ".Collection)"));
    }
    ...
    public void testGetSignatureProtectedMethod2() throws IOException, NoSuchMethodException {
        String s =
            SignatureUtils.signatureToString(SignatureUtils.makeSignature(TestClass.class, findTestMethod("protectedMethod2")), true);
        assertThat(s, is("protected io.codekvast.agent.lib.util.SignatureUtilsTest.TestClass.protectedMethod2()"));
    }

    @Test
    public void testGetSignaturePrivateMethod3() throws IOException, NoSuchMethodException {
        String s = SignatureUtils.signatureToString(
            SignatureUtils.makeSignature(TestClass.class, findTestMethod("privateMethod3")), true);
        assertThat(s, is("private io.codekvast.agent.lib.util.SignatureUtilsTest.TestClass.privateMethod3(int, java.lang.String[])"));
    }

    @Test
    public void testGetSignaturePackagePrivateMethod4() throws IOException, NoSuchMethodException {
        String s = SignatureUtils.signatureToString(
            SignatureUtils.makeSignature(TestClass.class, findTestMethod("packagePrivateMethod4")), true);
        assertThat(s, is("package-private io.codekvast.agent.lib.util.SignatureUtilsTest.TestClass.packagePrivateMethod4(int)"));
    }
    ...
    public void testMakeMethodSignature2() throws Exception {
        MethodSignature signature = SignatureUtils.makeMethodSignature(TestClass.class, findTestMethod("protectedMethod2"));
        assertThat(signature, notNullValue());
        assertThat(signature.getAspectjString(),
                   is("protected io.codekvast.agent.lib.util.SignatureUtilsTest.TestClass.protectedMethod2()"));
        assertThat(signature.getDeclaringType(), is("io.codekvast.agent.lib.util.SignatureUtilsTest$TestClass"));
        ...
        assertThat(signature.getPackageName(), is("io.codekvast.agent.lib.util"));
    ...
    public void testMakeMethodSignature5() throws Exception {
        MethodSignature signature = SignatureUtils.makeMethodSignature(TestClass.class, findTestMethod("protectedMethod5"));
        assertThat(signature, notNullValue());
        assertThat(signature.getAspectjString(),
                   is("protected io.codekvast.agent.lib.util.SignatureUtilsTest.TestClass.protectedMethod5(java.lang.String, io.codekvast.agent.lib.util.SignatureUtilsTest.TestInterface)"));
        assertThat(signature.getDeclaringType(), is("io.codekvast.agent.lib.util.SignatureUtilsTest$TestClass"));
        ...
        assertThat(signature.getParameterTypes(),
                   is("java.lang.String, io.codekvast.agent.lib.util.SignatureUtilsTest$TestInterface"));
        assertThat(signature.getReturnType(), is("int"));
    }

    @Test
    public void testMakeConstructorSignature1() throws Exception {
        MethodSignature signature = SignatureUtils.makeConstructorSignature(TestClass.class, findTestConstructor("TestClass()"));
        assertThat(signature, notNullValue());
        assertThat(signature.getAspectjString(), is("public io.codekvast.agent.lib.util.SignatureUtilsTest.TestClass()"));
        assertThat(signature.getDeclaringType(), is("io.codekvast.agent.lib.util.SignatureUtilsTest$TestClass"));
        assertThat(signature.getExceptionTypes(), is(""));
    ...
    public void testMakeConstructorSignature2() throws Exception {
        MethodSignature signature = SignatureUtils.makeConstructorSignature(TestClass.class, findTestConstructor("TestClass(int)"));
        assertThat(signature, notNullValue());
        assertThat(signature.getAspectjString(), is("protected io.codekvast.agent.lib.util.SignatureUtilsTest.TestClass(int)"));
        assertThat(signature.getDeclaringType(), is("io.codekvast.agent.lib.util.SignatureUtilsTest$TestClass"));
        assertThat(signature.getExceptionTypes(), is(""));
        assertThat(signature.getMethodName(), is("<init>"));
        assertThat(signature.getModifiers(), is("protected"));
    ...
    public void testMakeConstructorSignature3() throws Exception {
        MethodSignature signature = SignatureUtils.makeConstructorSignature(TestClass.class, findTestConstructor("TestClass(int,int)"));
        assertThat(signature, notNullValue());
        assertThat(signature.getAspectjString(),
                   is("package-private io.codekvast.agent.lib.util.SignatureUtilsTest.TestClass(int, int)"));
        assertThat(signature.getDeclaringType(), is("io.codekvast.agent.lib.util.SignatureUtilsTest$TestClass"));
        assertThat(signature.getExceptionTypes(), is("java.lang.UnsupportedOperationException"));
        assertThat(signature.getMethodName(), is("<init>"));
