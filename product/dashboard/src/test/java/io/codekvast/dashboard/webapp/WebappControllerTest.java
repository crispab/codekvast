...
public class WebappControllerTest {
    ...
    public void should_get_methodById() throws Exception {
        ...
        when(webappService.getMethodById(17L)).thenReturn(Optional.of(methodDescriptor));
        mockMvc.perform(get("/webapp/v1/method/detail/17"))
        ...
        verify(webappService).getMethodById(17L);
    }
}