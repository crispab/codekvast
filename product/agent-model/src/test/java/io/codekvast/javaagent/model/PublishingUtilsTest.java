...
public class PublishingUtilsTest {
    ...
    public void should_strip_existing_modifiers() throws Exception {
        String stripped = PublishingUtils
            .stripModifiers("public static strictfp void hudson.ClassicPluginStrategy.2(java.publishing.OutputStream, long)");
        assertThat(stripped, is("hudson.ClassicPluginStrategy.2(java.publishing.OutputStream, long)"));
    }

    @Test
    public void should_strip_missing_modifiers() throws Exception {
        String stripped = PublishingUtils.stripModifiers("hudson.ClassicPluginStrategy.2(java.publishing.OutputStream, long)");
        assertThat(stripped, is("hudson.ClassicPluginStrategy.2(java.publishing.OutputStream, long)"));
    }
