...
public class SignatureUtilsTest {
    ...
    public void testMakeMethodSignature5() throws Exception {
        ...
        assertThat(signature, notNullValue());
        assertThat(signature.getAspectjString(),
                   is("protected io.codekvast.javaagent.util.SignatureUtilsTest.TestClass.protectedMethod5(java.lang.String, io.codekvast.javaagent.util.SignatureUtilsTest.TestInterface)"));
        assertThat(signature.getDeclaringType(), is("io.codekvast.javaagent.util.SignatureUtilsTest$TestClass"));
