...
public class HerokuServiceImplTest {
  ...
  public void should_delegate_provision_to_customerService_addCustomer() throws HerokuException {
    ...
    // when
    service.provision(
        HerokuProvisionRequest.builder()
            .uuid("uuid")
            .heroku_id("heroku_id")
            .plan("the-plan")
            .build());
  ...
  public void should_deserialize_sample_real_provisioning_request() {
    // given
    HerokuProvisionRequest.OAuthGrant givenOAuthGrant =
    ...
    BufferedReader reader =
        new BufferedReader(
            new InputStreamReader(
                getClass().getResourceAsStream("/heroku/sample-heroku-provision-request.json")));
