...
public class SignatureHandler extends AbstractMessageHandler {
    ...
    private static final String[] fakeSignatures = {
            ...
            "se.su.dsv.exia.services.AttemptService.startExaminationAttempt(se.su.dsv.exia.domain.Personnummer, se.su.dsv.exia.domain.Examination)",
            ...
            "se.su.dsv.exia.services.QuestionService.findTopLevelQuestionsInPresentationOrder(se.su.dsv.exia.domain.ExaminationTest, java.lang.String)",
            ...
            "se.su.dsv.exia.services.QuestionService.save(se.su.dsv.exia.domain.Question, java.lang.String, java.lang.String, boolean, java.lang.String)",
            ...
            "se.su.dsv.exia.services.impl.AssessmentDelegationServiceImpl.1.compare(se.su.dsv.exia.domain.Examination, se.su.dsv.exia.domain.Examination)",
            ...
            "se.su.dsv.exia.services.impl.AssessmentDelegationServiceImpl.giveAssessmentPrivileges(java.lang.String, se.su.dsv.exia.domain.Examination)",
            "se.su.dsv.exia.services.impl.AssessmentDelegationServiceImpl.removeAssessmentPrivileges(se.su.dsv.exia.domain.AssessmentPrivilege)",
            "se.su.dsv.exia.services.impl.AssessmentDelegationServiceImpl.verifyAccess(java.lang.String, se.su.dsv.exia.domain.ExaminationTest)",
            ...
            "se.su.dsv.exia.services.impl.AssessmentServiceImpl.getPointsAssigned(se.su.dsv.exia.domain.Attempt, se.su.dsv.exia.domain.Question)",
            "se.su.dsv.exia.services.impl.AssessmentServiceImpl.hasPointsAssigned(se.su.dsv.exia.domain.Attempt, se.su.dsv.exia.domain.Question)",
            ...
            "se.su.dsv.exia.services.impl.AttemptServiceImpl.findAttempt(se.su.dsv.exia.domain.Examination, se.su.dsv.exia.domain.Personnummer)",
            ...
            "se.su.dsv.exia.services.impl.ExaminationServiceImpl.findAvailableExaminationsForPersonnummer(se.su.dsv.exia.domain.Personnummer, boolean)",
            "se.su.dsv.exia.services.impl.ExaminationServiceImpl.findExaminationsScheduledForTheFuture(java.lang.String)",
            "se.su.dsv.exia.services.impl.ExaminationServiceImpl.findOngoingExaminationsForPersonnummer(se.su.dsv.exia.domain.Personnummer, boolean)",
            ...
            "se.su.dsv.exia.services.impl.ExaminationTestServiceImpl.copy(se.su.dsv.exia.domain.ExaminationTest, java.lang.String, java.lang.String)",
            ...
            "se.su.dsv.exia.services.impl.ExaminationTestServiceImpl.updateRandomChoiceOrder(se.su.dsv.exia.domain.ExaminationTest, java.lang.Boolean)",
            "se.su.dsv.exia.services.impl.ExaminationTestServiceImpl.updateRandomOrder(se.su.dsv.exia.domain.ExaminationTest, java.lang.Boolean)",
