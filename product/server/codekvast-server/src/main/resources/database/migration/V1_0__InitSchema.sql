...
CREATE TABLE jvm_info (
  ...
  COMMENT 'The se.crisp.codekvast.shared.util.ComputerID value generated by the Codekvast Daemon',
  ...
  COMMENT 'The se.crisp.codekvast.shared.util.ComputerID value generated by the Codekvast Collector',
