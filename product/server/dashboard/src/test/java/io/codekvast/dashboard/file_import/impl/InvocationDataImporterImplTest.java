...
public class InvocationDataImporterImplTest {
    ...
    @InjectMocks
    private InvocationDataImporterImpl invocationDataImporter;
    ...
    public void should_ignore_synthetic_signatures() {
        // given
        String syntheticSignature = "customer1.FooConfig..EnhancerBySpringCGLIB..96aac875.CGLIB$BIND_CALLBACKS(java.lang.Object)";
        ...
        // then
        verify(metricsService).recordImportedPublication(PublicationType.INVOCATIONS, 1, 1, Duration.ZERO);
    }
