...
public class AgentControllerIntegrationTest {
  ...
  @MockBean private AmqpTemplate amqpTemplate;
  ...
  @Test
  public void should_accept_post_to_agentPollConfig_with_accept_application_json_1()
      throws Exception {
  ...
  @Test
  public void should_accept_post_to_agentPollConfig_with_accept_application_json_2()
      throws Exception {
  ...
  @Test
  public void should_accept_post_to_agentPollConfig_with_accept_application_json_utf8()
      throws Exception {
    GetConfigRequest2 request = GetConfigRequest2.sample();
    when(agentService.getConfig(request))
        .thenReturn(
