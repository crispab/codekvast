...
unzip codekvast-agent-{codekvast-version}.zip -d /opt
cd /opt
ln -s codekvast-agent-{codekvast-version} codekvast-agent
cd /opt/codekvast-agent/conf
cp codekvast-agent.properties.sample.{codekvast-version} codekvast-agent.properties # <1>
ln -s /opt/codekvast-agent/etc/init.d/codekvast-agent /etc/init.d
chkconfig --add /etc/init.d/codekvast-agent # <2>
----
<1> Edit codekvast-agent.properties to suit your needs. See <<configuring-codekvast-agent, Configuring Codekvast Agent>>.
<2> This works for Redhat-based Linux distros. For Debian-based distros, use `update-rc.d codekvast-agent defaults` instead.
...
chkconfig --add /etc/init.d/codekvast-server # <2>
----
<1> Edit codekvast-server.properties to suit your needs. See <<configuring-codekvast-server, Configuring Codekvast Server>>.
<2> This works for Redhad-based Linux distros. For Debian-based distros, use `update-rc.d codekvast-server defaults` instead.
