...
- Unzip it to the root of your application.
- Edit `codekvast.conf`
- Modify your application's start script to add `-javaagent:codekvast/javaagent/codekvast-agent-{codekvastVersion}-all.jar -Xbootclasspath/a:codekvast/javaagent/codekvast-agent-{codekvastVersion}-all.jar` to the `java` command.
...
`-javaagent:codekvast/agent/codekvast-agent-{codekvastVersion}-all.jar -Xbootclasspath/a:codekvast/agent/codekvast-agent-{codekvastVersion}-all.jar`

appear as arguments to the `java` command and to put `codekvast.conf` in any of the locations that
