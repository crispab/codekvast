...
- Edit `codekvast.conf`
- Modify your application's start script to add `-javaagent:codekvast/javaagent/codekvast-agent-{codekvastVersion}-all.jar -Djava.ext.dirs=codekvast/javaagent/codekvast-agent-{codekvastVersion}-all.jar` to the `java` command.
...
`-javaagent:codekvast/agent/codekvast-agent-{codekvastVersion}-all.jar -Djava.ext.dirs=codekvast/agent/codekvast-agent-{codekvastVersion}-all.jar`
