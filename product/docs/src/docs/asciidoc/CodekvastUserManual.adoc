...
- Edit `codekvast.conf`
- Modify your application's start script to add `-javaagent:codekvast/javaagent/codekvast-agent-{codekvastVersion}.jar -Xbootclasspath/a:codekvast/javaagent/codekvast-agent-{codekvastVersion}.jar` to the `java` command.
...
`-javaagent:codekvast/agent/codekvast-agent-{codekvastVersion}.jar -Xbootclasspath/a:codekvast/agent/codekvast-agent-{codekvastVersion}.jar`
