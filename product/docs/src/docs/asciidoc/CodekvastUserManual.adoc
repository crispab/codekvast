...
pushd /opt/codekvast-daemon-{codekvast-version}/conf
cp codekvast-daemon.properties.sample.{codekvast-version} codekvast-daemon.properties
popd
rm -f /etc/init.d/codekvast-daemon
ln -s /opt/codekvast-daemon-{codekvast-version}/etc/startscript/debian/codekvast-daemon /etc/init.d/codekvast-daemon # <1>
mkdir -p /var/log/codekvast
update-rc.d codekvast-daemon defaults # <1>
----
<1> This works for Debian-based Linux distros. For Redhat-based distros, use `chkconfig --add /etc/init.d/codekvast-daemon` instead.

Edit `/opt/codekvast-daemon-{codekvast-version}/conf/codekvast-daemon.properties` to suit your needs. See <<configuring-codekvast-daemon, Configuring Codekvast Daemon>>.
...
sudo mysql -e "create database if not exists codekvast_warehouse;grant all on codekvast_warehouse.* to 'codekvast'@'localhost' identified by 'codekvast';" # <2>
sudo wget {bintrayDownloadPrefix}/codekvast-warehouse-{codekvast-version}.zip
sudo unzip codekvast-warehouse-{codekvast-version}-svc.zip -d /opt
sudo chown codekvast:codekvast /opt/codekvast-warehouse-{codekvast-version}/codekvast-warehouse.jar # <1>
sudo ln -fs /opt/codekvast-warehouse-{codekvast-version}/codekvast-warehouse.jar /etc/init.d/codekvast-warehouse # <3>
