...
wget {bintray-download-prefix}/codekvast-ansible-{codekvast-version}.zip
...
sudo wget {bintray-download-prefix}/codekvast-daemon-{codekvast-version}.zip
...
[source,bash,subs="attributes,verbatim"]
----
wget {bintray-download-prefix}/docker-compose-{codekvast-version}.yml
docker-compose -p codekvast -f docker-compose-{codekvast-version}.yml up -d
----
...
EOF
sudo wget {bintray-download-prefix}/codekvast-warehouse-{codekvast-version}.zip
